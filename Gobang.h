...
private:
	...
	int timeDelay = NULL;  // bot与bot对决之间的延迟(1000ms)
	...
	char botName[10][16] = {"", "Bot1(简单)", "Bot2(中等)", "Bot3(困难)", "Bot4(孙庭宣)", "Bot5(徐郁博)" }; // Bot的名称
	// 棋盘属性
...
public:
	// 构造函数, 初始化操作界面
	Gobang(int onewidth, int oneheight, int twowidth, int twoheight) : wButton(5, vector<vector<int>>(10, vector<int>(4))), gameState(1) {
